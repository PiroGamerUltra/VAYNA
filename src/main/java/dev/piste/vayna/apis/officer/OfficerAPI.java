...
public class OfficerAPI {
    ...
    // Agents
    public Agent getAgent(String uuid, String languageCode) throws HttpErrorException {
    ...
    public ArrayList<Agent> getAgents(String languageCode) throws HttpErrorException {
    ...
    // Gamemodes
    public Gamemode getGamemode(String uuid, String languageCode) throws HttpErrorException {
    ...
    // Queues
    public Queue getQueue(String uuid, String languageCode) throws HttpErrorException {
    ...
    public ArrayList<Queue> getQueues(String languageCode) throws HttpErrorException {
    ...
    // Maps
    public Map getMap(String uuid, String languageCode) throws HttpErrorException {
    ...
    public ArrayList<Map> getMaps(String languageCode) throws HttpErrorException {
    ...
    // Weapons
    public Weapon getWeapon(String uuid, String languageCode) throws HttpErrorException {
    ...
    public ArrayList<Weapon> getWeapons(String languageCode) throws HttpErrorException {
    ...
    public Buddy getBuddy(String uuid, String languageCode) throws HttpErrorException {
    ...
    public Bundle getBundle(String uuid, String languageCode) throws HttpErrorException {
    ...
    public Playercard getPlayercard(String uuid, String languageCode) throws HttpErrorException {
    ...
    public Spray getSpray(String uuid, String languageCode) throws HttpErrorException {
    ...
    public CompetitiveTier getCompetitiveTier(String languageCode) throws HttpErrorException {
    ...
    public Skin getSkin(String uuid, String languageCode) throws HttpErrorException {
