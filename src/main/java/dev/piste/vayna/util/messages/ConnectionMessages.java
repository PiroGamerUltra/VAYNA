...
public class ConnectionMessages {
    ...
    public static MessageEmbed getConnectionPresent(String riotId, String discordMention, boolean visibleToPublic) {
        ...
        embed.addField("Connection", discordMention + " " + Emoji.getDiscord().getFormatted() + " \uD83D\uDD17 "
    ...
    public static MessageEmbed getNoConnectionPresent(String discordMention) {
        ...
        embed.addField("Connection", discordMention + " " + Emoji.getDiscord().getFormatted() + " " + Emoji.getBlank().getFormatted()
                + " " + Emoji.getRiotGames().getFormatted() + " `Not connected`", false);
        return embed.build();
    }
